...
export default function SignIn() {
  ...
  return (
    <div className=" h-screen flex flex-col gap-10 items-center justify-center ">
      <h1 className="font-montserrat text-5xl text-center lg:text-4xl transition-all font-bold">Jobx</h1>
    ...
    <Card className="w-full max-w-lg mx-auto border-1 border-zinc-300 shadow-xl">
      ...
      <CardContent className="space-y-4 font-poppins">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <Button type="submit" className="w-full font-poppins bg-blue-700 hover:bg-blue-700/90 transform transition-all duration-300 ease-in text-lg rounded-lg py-8" disabled={isLoading}>
            {isLoading ? (
              <>
